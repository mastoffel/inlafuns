#' Tidy random effect estimates from INLA
#'
#' @param inla_mod A fitted INLA model
#' @param scales Either "var", or "sd".
#'
#' @return Tibble with random effect estimates.
#' @export
#'
...
#' Transform precision to sd or var.
#'
#' @param prec Precision
#' @param scales "var" or "sd"
#' @param internal
#'
